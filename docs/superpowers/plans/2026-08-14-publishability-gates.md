...
# is why the leading slash is bracketed: the naive form '/Users/[^/ ]+/' DOES
# match the line it is written on, which is what made an earlier design exempt
# this file from its own scan. There is no exemption now.
version: 1
patterns:
  - id: macos-home-path
    regex: '[/]Users[/][^/ \t\r\n]+[/]'
